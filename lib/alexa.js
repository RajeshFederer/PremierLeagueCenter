...
skills.schedule = (req, res) =>{
    ...
    .then((finalSlotData)=>{
        ...
        if(finalSlotData.matchDay){
            console.log('DUDE', finalSlotData.matchDay.value, moment().isAfter(finalSlotData.matchDay.value));
        ...
        .then(body =>{
            ...
            if(body.code){
                ...
                if(finalSlotData.matchDay){
                    resObj.text = "OOPS! No matches on the date"
                }else if(finalSlotData.team) {
    ...
    return new Promise((resolve, reject) =>{
        ...
        async.forEachSeries(slotValues, function(slotObj, cback){
            ...
            if (reqSlotValue){
                ...
                if(res){
                    console.log('STRAIGHT', slotObj, reqSlots[slotObj.name], res);
                    let slotId = res.id || null;
